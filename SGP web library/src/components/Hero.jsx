...
const Hero = () => {
  return (
    <div className="w-full h-screen items-center justify-center flex flex-col">
        <div>
            <div className="w-full h-32  flex items-center justify-between absolute top-0 left-0 px-6">
        ...
        <div>
            <h1 className="text-5xl font-bold text-center">Welcome to SGP Web Library</h1>
            <p className="text-center mt-4 text-lg">A small part of memories in the form of code.</p>
        </div>
